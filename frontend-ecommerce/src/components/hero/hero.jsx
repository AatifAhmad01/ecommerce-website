...
export default function Hero()
{
    ...
    return(
        ...
        <div class="carousel-inner">
            <div class="carousel-item active hero-container" >
                <img src="images/hero.jpg" class="d-block w-100" alt="..."></img>
                <div class="carousel-caption d-none d-md-block" >
                    <h5>First slide label</h5>
                    <p>Some representative placeholder content for the first slide.</p>
                </div>
            </div>
            <div class="carousel-item hero-container">
            <img src="images/hero2.jpg" class="d-block w-100" alt="..."></img>
            <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item hero-container">
            <img src="images/hero3.jpg" class="d-block w-100" alt="..."></img>
            <div class="carousel-caption d-none d-md-block">
